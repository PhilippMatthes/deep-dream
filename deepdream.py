...
def render_deepdream(l, img0=img_noise,
    ...
    for octave in range(octave_n):
        ...
        for i in range(iter_n):
            print("Iteration {}/{}".format(i, iter_n))
            g = calc_grad_tiled(img, t_grad)
...
#    img = render_deepdream(tf.square(T(str(layer).replace("import/", "")), img0))
#    PIL.Image.fromarray(img).save("output/output_{}.jpeg".format(layer), "jpeg")
